...
const messages = [
    ...
    new Message("Josh Estrada", new Date('July 22, 2024 14:40:00'), "channel_2", true, "Woah woah woah. Wait a minute. Why you all roping me into this? HAHA. Of course I wouldn't have the slightest idea!"),

    new Message("Josh Estrada", new Date('July 21, 2024 11:05:00'), "channel_1", true, "Help me out!"),

    new Message("Eric Castillo", new Date('July 23, 2024 14:37:00'), "channel_3", false, "Josh. Where is our Accomplishment Report?"),
    new Message("Josh Estrada", new Date('July 23, 2024 14:39:00'), "channel_3", true, "Will send tonight, Sir."),
    new Message("Eric Castillo", new Date('July 23, 2024 14:52:00'), "channel_3", false, "Ok."),

    new Message("Rep. Presley", new Date('July 24, 2024 15:18:00'), "channel_4", false, "Good work, everyone."),
]
